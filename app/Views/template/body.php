                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-6 col-md-1">
                            <img class="my-0 site-logo" style="width: 50px; margin-left: -5px;" src="./assets/images/logo.jpg">
                        </div>
                        <div class="col-6 col-md-4">
                            <h1 class="my-0 site-logo" style="margin-left: -40px;"><a href="index.html">Maggiur<span class="text-primary">.</span> </a></h1>
                        </div>
        ...
        <div class="site-blocks-cover" id="home-section">
            <div class="img-wrap">
                <div class="owl-carousel slide-one-item hero-slider">
                    <div class="slide">
                        <img src="./assets/images/glint_hero_1.jpg" alt="Image">
                    </div>
                    <div class="slide">
                        <img src="./assets/images/glint_hero_2.jpg" alt="Image">
                    </div>
                    <div class="slide">
                        <img src="./assets/images/glint_hero_3.jpg" alt="Image">
                    </div>
                </div>
            </div>
            <div class="container">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5">
                        <img src="./assets/images/glint_about_1.jpg" alt="Image" class="img-fluid">
                    </div>
            ...
            <div class="container">
                ...
                <div class="row no-gutters">
                    <div class="col-lg-6 mb-5 person">
                        <img src="./assets/images/person_1.jpg" alt="Image" class="img-fluid mb-5">
                    ...
                    <div class="col-lg-6 person">
                        <img src="./assets/images/person_2.jpg" alt="Image" class="img-fluid mb-5">
                        <div class="row">
                            <div class="col-lg-10 ml-auto">
                                <div class="pr-lg-5">
                                    <h3>Chris Peters</h3>
            ...
            <div class="container">
                ...
                <div class="row mb-5">
                    <div class="col-lg-6 mb-4 mb-lg-0">
                        <img src="./assets/images/sq_img_2.jpg" alt="Image" class="img-fluid">
                    </div>
                        ...
                        <div class="testimonial bg-white h-100">
                            ...
                            <div class="d-flex align-items-center vcard">
                                <figure class="mb-0 mr-3">
                                    <img src="./assets/images/person_3.jpg" alt="Image" class="img-fluid ounded-circle">
                                </figure>
                ...
                <div class="row mb-5">
                    <div class="col-lg-6 order-1 order-lg-2 mb-4 mb-lg-0">
                        <img src="./assets/images/sq_img_4.jpg" alt="Image" class="img-fluid">
                    </div>
                    <div class="col-lg-5 h-100 jm-sticky-top mr-auto order-2 order-lg-1">
                        ...
                        <div class="testimonial bg-white h-100">
                            ...
                            <div class="d-flex align-items-center vcard">
                                <figure class="mb-0 mr-3">
                                    <img src="./assets/images/person_4.jpg" alt="Image" class="img-fluid ounded-circle">
                                </figure>
                                <div class="vcard-text">
                ...
                <div class="row mb-5">
                    <div class="col-lg-6 mb-4 mb-lg-0">
                        <img src="./assets/images/sq_img_6.jpg" alt="Image" class="img-fluid">
                    </div>
                    <div class="col-lg-5 h-100 jm-sticky-top ml-auto">
